...
import { transactionFiltersSchema, paginationSchema } from '@/lib/validation/schemas';
import { z } from 'zod';
...
export async function GET(request: NextRequest) {
  try {
    ...
    const filters = transactionFiltersSchema.parse(filtersInput);
    ...
    // Fetch transactions
    const result = await transactionsRepo.listTransactions(processedFilters, pagination);
