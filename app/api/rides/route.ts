...
import { rideFiltersSchema, paginationSchema } from '@/lib/validation/schemas';
import { z } from 'zod';
...
export async function GET(request: NextRequest) {
  try {
    ...
    const filtersInput = {
      ...
      ownerUid: searchParams.get('ownerUid') || undefined,
    ...
    const filters = rideFiltersSchema.parse(filtersInput);
    ...
    // Fetch rides
    const result = await ridesRepo.listRides(processedFilters, pagination);
