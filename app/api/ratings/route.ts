...
import { ratingFiltersSchema, paginationSchema } from '@/lib/validation/schemas';
import { z } from 'zod';
...
export async function GET(request: NextRequest) {
  try {
    ...
    const filters = ratingFiltersSchema.parse(filtersInput);
    ...
    // Fetch ratings
    const result = await ratingsRepo.listRatings(filters, pagination);
